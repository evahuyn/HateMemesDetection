...
```latex
mmf_run config=projects/hateful_memes/configs/mmbt/with_features.yaml model=mmbt dataset=hateful_memes \
run_type=val checkpoint.resume_file=./save/mmbt_final.pth checkpoint.resume_pretrained=False

mmf_run config=projects/hateful_memes/configs/mmbt/with_features.yaml model=mmbt dataset=hateful_memes \
run_type=test checkpoint.resume_file=./save/mmbt_final.pth checkpoint.resume_pretrained=False

mmf_predict config=projects/hateful_memes/configs/mmbt/with_features.yaml model=mmbt dataset=hateful_memes \
run_type=test checkpoint.resume_file=./save/mmbt_final.pth checkpoint.resume_pretrained=False
```
- Result
```latex
val/hateful_memes/cross_entropy: 0.9383, val/total_loss: 0.9383, val/hateful_memes/accuracy: 0.6907, val/hateful_memes/binary_f1: 0.4034, val/hateful_memes/roc_auc: 0.6760
